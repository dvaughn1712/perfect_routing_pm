...
/// Placed this here as it is missing from the refactoring version of PerfectLib as of this writing.
/// Will probably remove once things are in a more stable state.
/// However, file has been updated to work with Swift 3.0 toolchain DEVELOPMENT-snapshot-2016-03-24
...
public class JSONEncoder {
	...
	public func encode(a: [JSONValue]) throws -> String {
		...
		for value in a {
			...
			s.append(try encodeValue(value))
		}
		s.append("]")
		return s
	}
